...
export function CartaoRegistroModal({ isOpen, onClose, classeId, classeNome }: CartaoModalProps) {
  ...
  const handleGerarCartao = async () => {
    ...
    try {
      ...
      // Centros das 14 colunas de sábado (em mm)
      // 1º começa em 119mm (ajuste fino +1mm: centraliza melhor dentro das células do grid impresso)
      const SAB_X = [
        119.0, 123.5, 128.0, 132.5, 137.0, 141.5,
        146.0, 150.5, 155.0, 159.5, 164.0, 168.5,
        173.0, 177.5
      ];
